...
interface AuthDataSource {
    ...
    @Throws(exceptionClasses = [Exception::class])
    suspend fun doRegister(username:String, email : String, password : String, numberPhone : String) : Boolean
...
class FirebaseAuthDataSource(private val service : FirebaseService) : AuthDataSource {
    ...
    override suspend fun doRegister(
        username:String, email : String, password : String, numberPhone : String
    ): Boolean {
